  ...
  var moduleExports = (() => {
    ...
    var et = ((e) =>
      typeof require < 'u'
        ...
        : typeof Proxy < 'u'
          ? new Proxy(e, {
              get: (r, i) => (typeof require < 'u' ? require : r)[i],
            })
          : e)(function (e) {
    ...
    var nt = (e, r) => () => (
        ...
        if ((r && typeof r == 'object') || typeof r == 'function')
          for (let n of Gn(r))
            !Cn.call(e, n) &&
              ...
              Z(e, n, {
                get: () => r[n],
                enumerable: !(t = Yn(r, n)) || t.enumerable,
              });
        return e;
      },
      ...
      We = (e, r, i) => (
        ...
        G(
          r || !e || !e.__esModule
            ? Z(i, 'default', { value: e, enumerable: !0 })
            : i,
          e,
        )
      ),
    ...
    (function (e) {
      ...
      function i(t) {
        let n = t;
        return (
          a.objectLiteral(n) && a.uinteger(n.line) && a.uinteger(n.character)
        );
      }
      e.is = i;
    })(E || (E = {}));
    ...
    (function (e) {
      function r(t, n, o, s) {
        ...
        throw new Error(
          `Range#create called with invalid arguments[${t}, ${n}, ${o}, ${s}]`,
        );
      }
      e.create = r;
      function i(t) {
      ...
      function i(t) {
        ...
        return (
          ...
          (a.undefined(n.additionalTextEdits) ||
            a.typedArray(n.additionalTextEdits, N.is))
        );
      }
      e.is = i;
    })(Ue || (Ue = {}));
      ...
      function i(t) {
        ...
        return (
          ...
          (a.undefined(o.codeDescription) ||
            a.string(
              (n = o.codeDescription) === null || n === void 0
                ? void 0
                : n.href,
            )) &&
          (a.string(o.source) || a.undefined(o.source)) &&
          (a.undefined(o.relatedInformation) ||
            a.typedArray(o.relatedInformation, ce.is))
        );
      }
      e.is = i;
    })(ne || (ne = {}));
    ...
    (function (e) {
      ...
      function i(t) {
        ...
        return (
          a.defined(n) &&
          a.string(n.uri) &&
          (n.version === null || a.integer(n.version))
        );
      }
      e.is = i;
    })(ke || (ke = {}));
    ...
    (function (e) {
      ...
      function i(t) {
        ...
        return (
          a.defined(n) &&
          h.is(n.range) &&
          (a.undefined(n.command) || S.is(n.command))
        );
      }
      e.is = i;
    })(fn || (fn = {}));
    ...
    (function (e) {
      ...
      function i(t) {
        ...
        return (
          n != null &&
          h.is(n.range) &&
          (a.string(n.expression) || n.expression === void 0)
        );
      }
      e.is = i;
    })(Tn || (Tn = {}));
      ...
      function t(o, s) {
        let l = o.getText(),
          f = n(s, (g, c) => {
            ...
            return y === 0
              ? g.range.start.character - c.range.start.character
              : y;
          }),
          m = l.length;
        for (let g = f.length - 1; g >= 0; g--) {
          ...
          if (p <= m)
            l = l.substring(0, y) + c.newText + l.substring(p, l.length);
...
` &&
    ...
    (function (e) {
      ...
      function f(p) {
        return (
          r.call(p) === '[object Number]' && -2147483648 <= p && p <= 2147483647
        );
      }
      e.integer = f;
      function m(p) {
    ...
    var B = class {
      ...
      dispose() {
        (this._disposables.forEach((r) => r && r.dispose()),
              ...
              m = s.items.map((g) => {
                ...
                return (
                  g.textEdit &&
                    (ut(g.textEdit)
                      ? (c.range = {
                          insert: v(g.textEdit.insert),
                          replace: v(g.textEdit.replace),
                        })
                      : (c.range = v(g.textEdit.range)),
                    (c.insertText = g.textEdit.newText)),
                  g.additionalTextEdits &&
                    (c.additionalTextEdits = g.additionalTextEdits.map(M)),
    ...
    var xe = class {
      ...
      provideDocumentHighlights(r, i, t) {
        ...
        return this._worker(n)
          ...
          .then((o) => {
            if (o)
              return o.map((s) => ({ range: v(s.range), kind: pt(s.kind) }));
          });
      }
    };
    function pt(e) {
        ...
        provideLinks(r, i) {
          ...
          return this._worker(t)
            ...
            .then((n) => {
              if (n)
                return {
                  links: n.map((o) => ({ range: v(o.range), url: o.target })),
                };
            });
        }
      },
    ...
    var X = class {
        ...
        provideDocumentColors(r, i) {
          ...
          return this._worker(t)
            ...
            .then((n) => {
              if (n)
                return n.map((o) => ({ color: o.color, range: v(o.range) }));
            });
        }
        provideColorPresentations(r, i, t) {
          ...
          return this._worker(n)
            .then((o) =>
              o.getColorPresentations(n.toString(), i.color, Le(i.range)),
            )
            .then((o) => {
              if (o)
                return o.map((s) => {
                  ...
                  return (
                    ...
                    s.additionalTextEdits &&
                      (l.additionalTextEdits = s.additionalTextEdits.map(M)),
                    l
                  );
                });
            });
          ...
          case 47:
            ...
            if (e.charCodeAt(t + 1) === 42) {
              ...
              for (; t < _; ) {
                ...
                (t++,
                  Y(T) &&
                    (T === 13 && e.charCodeAt(t) === 10 && t++, l++, (m = t)));
              }
      ...
      function n() {
        ...
        (Kn(i),
          l.documentFormattingEdits &&
            i.push(
              u.languages.registerDocumentFormattingEditProvider(s, new $(w)),
            ),
          ...
          l.documentSymbols &&
            i.push(u.languages.registerDocumentSymbolProvider(s, new z(w))),
          l.tokens && i.push(u.languages.setTokensProvider(s, zn(!0))),
          l.colors && i.push(u.languages.registerColorProvider(s, new X(w))),
          l.foldingRanges &&
            i.push(u.languages.registerFoldingRangeProvider(s, new q(w))),
          l.diagnostics && i.push(new Oe(s, w, e)),
          l.selectionRanges &&
            i.push(u.languages.registerSelectionRangeProvider(s, new Q(w))));
      }
