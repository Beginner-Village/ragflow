        ...
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let i of vr(t))
            !xr.call(e, i) &&
              ...
              ft(e, i, {
                get: () => t[i],
                enumerable: !(n = br(t, i)) || n.enumerable,
              });
        return e;
      };
          ...
          case 47:
            ...
            if (e.charCodeAt(n + 1) === 42) {
              ...
              for (; n < x; ) {
                ...
                (n++,
                  Ie(O) &&
                    (O === 13 && e.charCodeAt(n) === 10 && n++, c++, (a = n)));
              }
...
`,
    ...
    function pt(e, t, r) {
      let n, i, s, o, c;
      if (t) {
        for (o = t.offset, c = o + t.length, s = o; s > 0 && !ht(e, s - 1); )
          s--;
        let x = c;
      ...
      let l = Tr(r, e),
        ...
        d;
      r.insertSpaces
        ? (d = Q[r.tabSize || 4] ?? Oe(Q[1], r.tabSize || 4))
        : (d = '	');
      let h = d === '	' ? '	' : ' ',
        p = Se(i, !1),
        m = !1;
...
`.indexOf(e.charAt(t)) !== -1
    ...
    function ln(e, t, r = De.DEFAULT) {
      ...
      function j() {
        ...
        for (; n.getToken() !== 4 && n.getToken() !== 17; ) {
          if (n.getToken() === 5) {
            if ((P || x(4, [], []), m(','), S(), n.getToken() === 4 && g))
              break;
          } else P && x(6, [], []);
          (v ? (i.push(0), (v = !1)) : i[i.length - 1]++,
            N() || x(4, [], [4, 5]),
            (P = !0));
        }
        return (
    ...
    (function (e) {
      ...
      function r(n) {
        let i = n;
        return (
          b.objectLiteral(i) && b.uinteger(i.line) && b.uinteger(i.character)
        );
      }
      e.is = r;
    })(D || (D = {}));
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          b.objectLiteral(i) &&
          _.is(i.range) &&
          (b.string(i.uri) || b.undefined(i.uri))
        );
      }
      e.is = r;
    })(ue || (ue = {}));
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          ...
          (b.undefined(i.additionalTextEdits) ||
            b.typedArray(i.additionalTextEdits, G.is))
        );
      }
      e.is = r;
    })(At || (At = {}));
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          ...
          (b.undefined(s.relatedInformation) ||
            b.typedArray(s.relatedInformation, wt.is))
        );
      }
      e.is = r;
    })(ne || (ne = {}));
        ...
        return (
          ...
          (i.options === void 0 ||
            ((i.options.overwrite === void 0 ||
              b.boolean(i.options.overwrite)) &&
              (i.options.ignoreIfExists === void 0 ||
                b.boolean(i.options.ignoreIfExists)))) &&
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          b.defined(i) &&
          b.string(i.uri) &&
          (i.version === null || b.integer(i.version))
        );
      }
      e.is = r;
    })(It || (It = {}));
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          b.string(i) ||
          (b.objectLiteral(i) && b.string(i.language) && b.string(i.value))
        );
      }
      e.is = r;
    })(_e || (_e = {}));
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          b.defined(i) &&
          _.is(i.range) &&
          (b.undefined(i.command) || be.is(i.command))
        );
      }
      e.is = r;
    })(_n || (_n = {}));
    ...
    (function (e) {
      ...
      function r(n) {
        let i = n;
        return (
          b.defined(i) && b.uinteger(i.tabSize) && b.boolean(i.insertSpaces)
        );
      }
      e.is = r;
    })(jn || (jn = {}));
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          b.defined(i) &&
          _.is(i.range) &&
          (b.undefined(i.target) || b.string(i.target))
        );
      }
      e.is = r;
    })(Bt || (Bt = {}));
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          i != null &&
          _.is(i.range) &&
          (b.string(i.expression) || i.expression === void 0)
        );
      }
      e.is = r;
    })(Rn || (Rn = {}));
      ...
      function n(s, o) {
        let c = s.getText(),
          l = i(o, (u, f) => {
            ...
            return d === 0
              ? u.range.start.character - f.range.start.character
              : d;
          }),
          a = c.length;
        for (let u = l.length - 1; u >= 0; u--) {
          ...
          if (h <= a)
            c = c.substring(0, d) + f.newText + c.substring(h, c.length);
...
` &&
    ...
    (function (e) {
      ...
      function l(h) {
        return (
          t.call(h) === '[object Number]' && -2147483648 <= h && h <= 2147483647
        );
      }
      e.integer = l;
      function a(h) {
          ...
          for (let n of t)
            if (e.isIncremental(n)) {
              ...
              let c = Math.max(i.start.line, 0),
                ...
                u = Zn(n.text, !1, s);
              if (l - c === u.length)
                for (let d = 0, h = u.length; d < h; d++) a[d + c + 1] = u[d];
              else
                u.length < 1e4
                  ? a.splice(c + 1, l - c, ...u)
                  : (this._lineOffsets = a =
                      a.slice(0, c + 1).concat(u, a.slice(l + 1)));
              let f = n.text.length - (o - s);
              if (f !== 0)
                for (let d = c + 1 + u.length, h = a.length; d < h; d++)
                  a[d] = a[d] + f;
            } else if (e.isFull(n))
    ...
    var Dr = {
      ...
      Qt = class e {
        ...
        include(t) {
          return (
            (this.focusOffset === -1 || Yt(t, this.focusOffset)) &&
            t !== this.exclude
          );
        }
        newSub() {
        ...
        if (this.root) {
          let r = (n) => {
            let i = t(n),
              s = n.children;
            if (Array.isArray(s))
              for (let o = 0; o < s.length && i; o++) i = r(s[o]);
            return i;
          };
          r(this.root);
        }
    ...
    function C(e, t, r, n, i) {
      ...
      function o() {
        function f(w) {
          return (
            s.type === w ||
            (w === 'integer' && s.type === 'number' && s.isInteger)
          );
        }
        if (
          (Array.isArray(t.type)
            ? t.type.some(f) ||
              r.problems.push({
                ...
                message:
                  t.errorMessage ||
                  A('Incorrect type. Expected one of {0}.', t.type.join(', ')),
              })
            : t.type &&
              (f(t.type) ||
                r.problems.push({
                  ...
                  message:
                    t.errorMessage ||
                    A('Incorrect type. Expected "{0}".', t.type),
                })),
          ...
          (C(s, d, w, g, i),
            w.hasProblems() ||
              r.problems.push({
                location: { offset: s.offset, length: s.length },
                message:
                  t.errorMessage || A('Matches a schema that is not allowed.'),
              }));
          ...
          for (let T of w) {
            ...
            if ((C(s, O, I, E, i), I.hasProblems() || S.push(O), !x))
              ...
              j > 0
                ...
                : j === 0 &&
                  (x.matchingSchemas.merge(E),
                  x.validationResult.mergeEnumValues(I));
            }
          }
          return (
            S.length > 1 &&
        ...
        (Array.isArray(t.anyOf) && h(t.anyOf, !1),
          Array.isArray(t.oneOf) && h(t.oneOf, !0));
        let p = (w) => {
            let g = new q(),
              S = n.newSub();
            (C(s, Z(w), g, S, i), r.merge(g), n.merge(S));
        ...
        if (Y(t.const)) {
          ...
          (ge(w, t.const)
            ...
            : (r.problems.push({
                ...
                message:
                  t.errorMessage ||
                  A('Value must be {0}.', JSON.stringify(t.const)),
              }),
              (r.enumValueMatch = !1)),
            ...
            case 'uri-reference':
              {
                ...
                if (!f.value) h = A('URI expected.');
                  ...
                  p
                    ? !p[2] &&
                      t.format === 'uri' &&
                      (h = A('URI with a scheme is expected.'))
                    : (h = A('URI is expected.'));
                }
                h &&
                  r.problems.push({
            ...
            case 'ipv6':
              ...
              (!f.value || !d.pattern.exec(f.value)) &&
                r.problems.push({
                  location: { offset: f.offset, length: f.length },
                  message:
                    t.patternErrorMessage || t.errorMessage || d.errorMessage,
                });
            default:
          }
      }
      function a(f) {
        ...
        i.schemaDraft >= ie.v2020_12
          ? ((d = t.prefixItems),
            (h = Array.isArray(t.items) ? void 0 : t.items))
          ...
          for (let w = 0; w < f.items.length; w++) {
            ...
            (C(g, m, S, ve.instance, i),
              S.hasProblems() ||
                (k++,
                i.schemaDraft >= ie.v2020_12 &&
                  r.processedProperties.add(String(w))));
          }
          (k === 0 &&
            !W(t.minContains) &&
            r.problems.push({
              location: { offset: f.offset, length: f.length },
              message:
                t.errorMessage || A('Array does not contain required item.'),
            }),
            W(t.minContains) &&
              k < t.minContains &&
              r.problems.push({
          ...
          for (let k = 0; k < f.items.length; k++) {
            if (!r.processedProperties.has(String(k)))
              if (y === !1)
                ...
                let w = new q();
                (C(f.items[k], t.unevaluatedItems, w, n, i),
                  r.mergePropertyMatch(w));
              }
      ...
      function u(f) {
        ...
        if (Array.isArray(t.required)) {
          for (let g of t.required)
            if (!d[g]) {
              ...
              r.problems.push({
                location: x,
                message: A('Missing property "{0}".', g),
              });
            }
        }
        let p = (g) => {
              ...
              if (te(S))
                if (S) (r.propertiesMatches++, r.propertiesValueMatches++);
                  ...
                  r.problems.push({
                    ...
                    message:
                      t.errorMessage || A('Property {0} is not allowed.', g),
                  });
                }
              else {
                let T = new q();
          ...
          for (let g of h) {
            ...
            if (S) {
              if (m === !1) {
                ...
                r.problems.push({
                  location: {
                    offset: x.keyNode.offset,
                    length: x.keyNode.length,
                  },
                  message:
                    t.errorMessage || A('Property {0} is not allowed.', g),
                });
              ...
              if (x) {
                if (y === !1) {
                  ...
                  r.problems.push({
                    ...
                    message:
                      t.errorMessage || A('Property {0} is not allowed.', S),
                  });
                } else if (y !== !0) {
                  let T = new q();
        ...
        if (t.dependencies)
          for (let g in t.dependencies) d[g] && w(g, t.dependencies[g]);
    ...
    function tr(e, t) {
      ...
      function f() {
        switch (s.getTokenError()) {
          case 4:
            return (
              u(A('Invalid unicode sequence in string.'), M.InvalidUnicode),
              !0
            );
          case 5:
            return (
              u(
                A('Invalid escape character in string.'),
                M.InvalidEscapeCharacter,
              ),
              !0
            );
          case 3:
            return (
              u(A('Unexpected end of number.'), M.UnexpectedEndOfNumber),
              !0
            );
          case 1:
            return (
              u(A('Unexpected end of comment.'), M.UnexpectedEndOfComment),
              !0
            );
          case 2:
            return (
              u(A('Unexpected end of string.'), M.UnexpectedEndOfString),
              !0
            );
          case 6:
            return (
      ...
      function d(O, I) {
        return (
          (O.length = s.getTokenOffset() + s.getTokenLength() - O.offset),
          I && c(),
          O
        );
      }
      function h(O) {
        ...
        for (; s.getToken() !== 4 && s.getToken() !== 17; ) {
          ...
          (N
            ? I.items.push(N)
            : u(A('Value expected'), M.ValueExpected, void 0, [], [4, 5]),
            (j = !0));
        }
        return s.getToken() !== 4
          ? u(
              A('Expected comma or closing bracket'),
              M.CommaOrCloseBacketExpected,
              I,
            )
          : d(I, !0);
      }
      ...
      function m(O, I) {
        ...
        if (!j)
          if (s.getToken() === 16) {
            u(
              A('Property keys must be doublequoted'),
              M.PropertyKeysMustBeDoublequoted,
            );
        ...
        if (s.getToken() === 6) ((E.colonOffset = s.getTokenOffset()), c());
          ...
          s.getToken() === 10 &&
            e.positionAt(j.offset + j.length).line <
      ...
      function y(O) {
        ...
        return s.getToken() !== 2
          ? u(
              A('Expected comma or closing brace'),
              M.CommaOrCloseBraceExpected,
              I,
            )
          : d(I, !0);
      }
    ...
    var Rr = [',', '}', ']'],
      ...
      et = class {
        ...
        doComplete(t, r, n) {
          ...
          if (this.isInComment(t, c ? c.offset : 0, o))
          ...
          if (
            ...
            a = _.create(
              t.positionAt(c.offset),
              t.positionAt(c.offset + c.length),
            );
          else {
            let h = o - l.length;
            (h > 0 && s[h - 1] === '"' && h--,
              (a = _.create(t.positionAt(h), r)));
          }
          let u = !1,
            f = new Map(),
            d = {
          ...
          return this.schemaService.getSchemaForResource(t.uri, n).then((h) => {
            ...
            if (c && c.type === 'object') {
              ...
              (this.contributions.forEach((T) => {
                let O = T.collectPropertyCompletions(
                  t.uri,
                  x,
                  l,
                  m,
                ...
                Object.keys(a).forEach((f) => {
                  ...
                  if (
                    ...
                    let h = {
                      ...
                      documentation:
                        this.fromMarkup(d.markdownDescription) ||
                        d.description ||
                        '',
                    };
                    (d.suggestSortText !== void 0 &&
                      (h.sortText = d.suggestSortText),
                      h.insertText &&
                        fe(h.insertText, `$1${s}`) &&
                        (h.command = {
                          title: 'Suggest',
              ...
              if (
                ...
                let f = (d, h = void 0) => {
                  let p = {
                    ...
                    documentation:
                      h ||
                      this.fromMarkup(u.markdownDescription) ||
                      u.description ||
                      '',
                  };
                  (u.suggestSortText !== void 0 &&
                    (p.sortText = u.suggestSortText),
                    p.insertText &&
                      fe(p.insertText, `$1${s}`) &&
                      (p.command = {
                        title: 'Suggest',
                ...
                if (u.enum)
                  for (let d = 0; d < u.enum.length; d++) {
                    ...
                    d < u.markdownEnumDescriptions.length
          ...
          let c = this.evaluateSeparatorAfter(i, o),
            l = (a) => {
              (a.parent &&
                ...
                a.type === 'boolean' &&
                  this.addBooleanValueCompletion(!a.value, c, s));
            };
              ...
              if (h.node === n && !h.inverted && h.schema) {
                if (n.type === 'array' && h.schema.items) {
                  ...
                  if (Array.isArray(h.schema.items)) {
                    ...
                    this.addSchemaValueCompletions(h.schema.items, f, p, c);
                }
                if (a !== void 0) {
                  let p = !1;
        ...
        addSchemaValueCompletions(t, r, n, i) {
          typeof t == 'object' &&
            ...
            Array.isArray(t.allOf) &&
              t.allOf.forEach((s) =>
                this.addSchemaValueCompletions(s, r, n, i),
              ),
...
` + p,
                ...
                (n.add({
                  ...
                  label: a,
                  documentation:
                    this.fromMarkup(o.markdownDescription) || o.description,
                  insertText: u,
                  insertTextFormat: R.Snippet,
                  filterText: f,
                }),
          ...
          if (
            (Y(t.const) &&
              n.add({
                ...
                insertTextFormat: R.Snippet,
                documentation:
                  this.fromMarkup(t.markdownDescription) || t.description,
              }),
        ...
        getInsertTextForGuessedValue(t, r) {
          switch (typeof t) {
            case 'object':
              return t === null
                ? '${1:null}' + r
                : this.getInsertTextForValue(t, r);
            case 'string':
          ...
          if (r) {
            ...
            if (
              (r.enum &&
                ...
                (l += r.enum.length)),
              Y(r.const) &&
                (c || (c = this.getInsertTextForGuessedValue(r.const, '')),
                l++),
              Y(r.default) &&
                (c || (c = this.getInsertTextForGuessedValue(r.default, '')),
                l++),
              Array.isArray(r.examples) &&
                r.examples.length &&
                (c ||
                  (c = this.getInsertTextForGuessedValue(r.examples[0], '')),
                (l += r.examples.length)),
              l === 0)
            ) {
              ...
              switch (
                (a ||
                  (r.properties ? (a = 'object') : r.items && (a = 'array')),
                a)
              ) {
                case 'boolean':
                  c = '$1';
...
\r\v":{[,]}`.indexOf(i.charAt(n)) === -1;
          ...
          for (let o = s.length - 1; o >= 0; o--) {
            ...
            if (n > c.offset + c.length)
              return (
                ...
                i.scan() === 5 && n >= i.getTokenOffset() + i.getTokenLength()
                  ? o + 1
                  : o
              );
        ...
        isInComment(t, r, n) {
          ...
          i.setPosition(r);
          let s = i.scan();
          for (; s !== 17 && i.getTokenOffset() + i.getTokenLength() < n; )
            s = i.scan();
          return (s === 12 || s === 13) && i.getTokenOffset() <= n;
        }
        fromMarkup(t) {
          if (t && this.doesSupportMarkdown())
            return { kind: le.Markdown, value: t };
        }
        doesSupportMarkdown() {
          if (!Y(this.supportsMarkdown)) {
            ...
            this.supportsMarkdown =
              Array.isArray(t) && t.indexOf(le.Markdown) !== -1;
          }
    ...
    var tt = class {
      ...
      doHover(t, r, n) {
        ...
        let c = _.create(
            t.positionAt(o.offset),
            t.positionAt(o.offset + o.length),
          ),
          ...
          if (u && s) {
            ...
            f.every((k) => {
              if (
                ...
                (h =
                  h ||
                  k.schema.markdownDescription ||
                  Kt(k.schema.description)),
                k.schema.enum)
              ) {
                let w = k.schema.enum.indexOf(ae(s));
                (k.schema.markdownEnumDescriptions
                  ? (p = k.schema.markdownEnumDescriptions[w])
                  : k.schema.enumDescriptions &&
                    (p = Kt(k.schema.enumDescriptions[w])),
                  p &&
                    ((m = k.schema.enum[w]),
...
$3`,
    ...
    var rt = class {
        ...
        doValidation(t, r, n, i) {
                ...
                let p = (m, y) => {
                  if (r.root && h) {
                    ...
                    if (w && w.keyNode.value === '$schema') {
                      let g = w.valueNode || w,
                        S = _.create(
                          t.positionAt(g.offset),
                          t.positionAt(g.offset + g.length),
                        );
                      c(ne.create(S, m, h, y));
                    } else {
                      let g = _.create(
                        t.positionAt(k.offset),
                        t.positionAt(k.offset + 1),
                      );
                      c(ne.create(g, m, h, y));
                    }
                  }
          ...
          return this.jsonSchemaService
            .getSchemaForResource(t.uri, r)
            .then((a) => l(a));
        }
        getLanguageStatus(t, r) {
          return {
            schemas: this.jsonSchemaService.getSchemaURIsForResource(t.uri, r),
          };
        }
      },
      Jr = 0;
    ...
    var it = class {
      ...
      findDocumentSymbols(t, r, n = { resultLimit: Number.MAX_VALUE }) {
        ...
        return (
          a && n && n.onResultLimitExceeded && n.onResultLimitExceeded(o),
          u
        );
      }
      findDocumentSymbols2(t, r, n = { resultLimit: Number.MAX_VALUE }) {
        ...
        return (
          u && n && n.onResultLimitExceeded && n.onResultLimitExceeded(o),
          c
        );
      }
      getSymbolKind(t) {
          ...
          if (i) {
            ...
            for (let a of c)
              if (
                !a.inverted &&
                a.schema &&
                (a.schema.format === 'color' ||
                  a.schema.format === 'color-hex') &&
                a.node &&
                a.node.type === 'string'
              ) {
      ...
      var e = {
          470: (i) => {
            ...
            var c = {
              resolve: function () {
                for (
                  var l, a = '', u = !1, f = arguments.length - 1;
                  f >= -1 && !u;
                  f--
                ) {
                  var d;
                  (f >= 0
                    ? (d = arguments[f])
                    : (l === void 0 && (l = process.cwd()), (d = l)),
                    s(d),
                    d.length !== 0 &&
                      ((a = d + '/' + a), (u = d.charCodeAt(0) === 47)));
                }
                return (
                  (a = o(a, !u)),
              ...
              relative: function (l, a) {
                if (
                  (s(l),
                  s(a),
                  l === a || (l = c.resolve(l)) === (a = c.resolve(a)))
                )
                  return '';
                ...
                for (
                  var p = a.length - h, m = d < p ? d : p, y = -1, k = 0;
                  k <= m;
                  ++k
                ) {
                  if (k === m) {
              ...
              extname: function (l) {
                s(l);
                for (
                  var a = -1, u = 0, f = -1, d = !0, h = 0, p = l.length - 1;
                  p >= 0;
                  --p
                ) {
              ...
              parse: function (l) {
                ...
                d ? ((a.root = '/'), (u = 1)) : (u = 0);
                for (
                  var h = -1, p = 0, m = -1, y = !0, k = l.length - 1, w = 0;
                  k >= u;
                  --k
                )
        ...
        function y(N, v, P) {
          ...
          for (let F = 0; F < N.length; F++) {
            ...
            if (
              ...
              ($ !== -1 &&
                ((L += encodeURIComponent(N.substring($, F))), ($ = -1)),
          ...
          return (
            $ !== -1 && (L += encodeURIComponent(N.substring($))),
            L !== void 0 ? L : N
          );
        }
        function k(N) {
            ...
            (P =
              N.authority && N.path.length > 1 && N.scheme === 'file'
                ...
                : N.path.charCodeAt(0) === 47 &&
                    ((N.path.charCodeAt(1) >= 65 &&
                      N.path.charCodeAt(1) <= 90) ||
                      (N.path.charCodeAt(1) >= 97 &&
                        N.path.charCodeAt(1) <= 122)) &&
        ...
        function g(N, v) {
          ...
          if (V) {
            if (
              ...
              J >= 65 &&
                J <= 90 &&
                (V = `/${String.fromCharCode(J + 32)}:${V.substr(3)}`);
            } else if (V.length >= 2 && V.charCodeAt(1) === 58) {
              let J = V.charCodeAt(0);
              J >= 65 &&
                J <= 90 &&
                (V = `${String.fromCharCode(J + 32)}:${V.substr(2)}`);
            }
            L += P(V, !0, !1);
          }
          return (
        ...
        (function (N) {
          ((N.joinPath = function (v, ...P) {
            ...
            (N.resolvePath = function (v, ...P) {
              ...
              let F = I.resolve(L, ...P);
              return (
                $ && F[0] === E && !v.authority && (F = F.substring(1)),
                v.with({ path: F })
              );
            }),
            (N.dirname = function (v) {
              ...
              return (
                P.length === 1 && P.charCodeAt(0) === 46 && (P = ''),
                v.with({ path: P })
              );
            }),
    ...
    var qr = '!',
      ...
      en = class {
        ...
        matchesPattern(t) {
          ...
          let r = !1;
          for (let { regexp: n, include: i } of this.globWrappers)
            n.test(t) && (r = i);
          return r;
        }
        getURIs() {
        ...
        getSectionRecursive(t, r) {
          ...
          if (r.patternProperties) {
            for (let i of Object.keys(r.patternProperties))
              if (me(i)?.test(n))
                return this.getSectionRecursive(t, r.patternProperties[i]);
          } else {
            ...
            if (n.match('[0-9]+')) {
              if (Array.isArray(r.items)) {
                let i = parseInt(n, 10);
                if (!isNaN(i) && r.items[i])
                  return this.getSectionRecursive(t, r.items[i]);
      ...
      at = class {
        ...
        registerExternalSchema(t) {
          ...
          return (
            ...
            t.schema
              ? this.addSchemaHandle(r, t.schema)
              : this.getOrAddSchemaHandle(r)
          );
        }
        clearExternalSchemas() {
          ...
          for (let t of this.contributionAssociations)
        ...
        loadSchema(t) {
          ...
          return (
            t.startsWith('http://json-schema.org/') &&
              (t = 'https' + t.substring(4)),
            this.requestService(t).then(
              ...
              (r) => {
                ...
                return (
                  ...
                  new xe({}, [
                    A("Unable to load schema from '{0}': {1}.", Me(t), n),
                  ])
                );
              },
            )
            ...
            d = (m, y, k, w) => {
              ...
              return g.getUnresolvedSchema().then((S) => {
                if ((w.dependencies.add(y), S.errors.length)) {
                  let x = k ? y + '#' + k : y;
                  n.push(
                    A("Problems loading reference '{0}': {1}", x, S.errors[0]),
                  );
                }
            ...
            p = (m) => {
              ...
              return (
                this.traverseNodes(m, (k) => {
                  let w = k.$id || k.id,
                    g =
                      Ue(w) && w.charAt(0) === '#' ? w.substring(1) : k.$anchor;
                  (g &&
                    (y.has(g)
                      ? n.push(A("Duplicate anchor declaration: '{0}'", g))
                      : y.set(g, k)),
        ...
        traverseNodes(t, r) {
          ...
          let n = new Set(),
            ...
            o = (...u) => {
              for (let f of u)
                if (Array.isArray(f)) for (let d of f) oe(d) && l.push(d);
            },
            c = (u) => {
        ...
        getAssociatedSchemas(t) {
          ...
          for (let s of this.filePatternAssociations)
            if (s.matchesPattern(i))
              for (let o of s.getURIs()) r[o] || (n.push(o), (r[o] = !0));
          return n;
        }
        ...
        getSchemaForResource(t, r) {
          ...
          if (
            ...
            this.cachedSchemaForResource.resource === t
          )
          ...
          return (
            (this.cachedSchemaForResource = { resource: t, resolvedSchema: i }),
            i
          );
        }
        ...
        getMatchingSchemas(t, r, n) {
          if (n) {
            ...
            return this.addSchemaHandle(i, n)
              .getResolvedSchema()
              .then((o) =>
                r.getMatchingSchemas(o.schema).filter((c) => !c.inverted),
              );
          }
        ...
        switch (c) {
          ...
          case 13: {
            ...
            o.getTokenError() === 1 && p + 1 < e.lineCount
              ...
              : p < m &&
                (l({ startLine: p, endLine: m, kind: ye.Comment }), (s = p));
            break;
          }
          case 12: {
            let m = e
    ...
    function fr(e, t, r) {
      ...
      function o(c, l) {
        return (
          s.setPosition(c),
          s.scan() === l ? s.getTokenOffset() + s.getTokenLength() : -1
        );
      }
      return t.map(n);
    }
...
`,
      ...
      return mn(e.getText(), n, i).map((s) =>
        G.replace(
          _.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length)),
          s.content,
        ),
      );
    }
    ...
    function dr(e, t) {
      ...
      return [
        G.replace(
          _.create(D.create(0, 0), e.positionAt(e.getText().length)),
          l,
        ),
      ];
    }
      ...
      for (; (c = r.scan()) !== 17; ) {
        ...
        if (
          ...
          for (let g = l; g < r.getTokenStartLine(); g++) {
            let S = e.getText(
              _.create(D.create(g, 0), D.create(g + 1, 0)),
            ).length;
            a = a + S;
          }
        ...
        switch (c) {
          ...
          case 3: {
            if (
              (n.beginningLineNumber === void 0 &&
                (n.beginningLineNumber = r.getTokenStartLine()),
              ...
              ((g.noKeyName = !0),
                (o = s),
                (s = i.addChildProperty(g)),
                (i = s));
            }
            (y.push(B.Array),
              (s.type = B.Array),
              (p = r.getTokenStartLine()),
              p++);
            break;
          }
          case 1: {
            if (n.beginningLineNumber === void 0)
              n.beginningLineNumber = r.getTokenStartLine();
            else if (y[y.length - 1] === B.Array) {
              let g = new ke(r.getTokenValue(), p);
          ...
          case 5: {
            ((m = r.getTokenStartLine()),
              s.endLineNumber === void 0 &&
                ...
                ((s.endLineNumber = m),
                (s.commaIndex = r.getTokenOffset() - a),
                (s.commaLine = m)),
              (u === 2 || u === 4) &&
                ((o = s), (s = s ? s.parent : void 0), (i = s)),
              (p = m + 1));
            break;
          }
          case 13: {
    ...
    function Zr(e, t) {
      ...
      for (ur(n, t, t.beginningLineNumber); n.length > 0; ) {
        ...
        for (let c = 0; c < s.length; c++) {
          let l = s[c],
            a = _.create(
              D.create(l.beginningLineNumber, 0),
              D.create(l.endLineNumber + 1, 0),
            ),
            u = e.getText(a),
          ...
          if (l.lastProperty === !0 && c !== s.length - 1) {
            let p = l.lineWhereToAddComma - l.beginningLineNumber,
              ...
              y = {
                range: _.create(D.create(p, m), D.create(p, m)),
                text: ',',
              };
            X.update(f, [y], 1);
            ...
            let p = l.commaIndex,
              ...
              k = {
                range: _.create(D.create(y, p), D.create(y, p + 1)),
                text: '',
              };
            X.update(f, [k], 1);
          }
          let d = l.endLineNumber - l.beginningLineNumber + 1,
            h = {
              range: _.create(D.create(o, 0), D.create(o + d, 0)),
              text: f.getText(),
            };
    ...
    function hr(e, t, r) {
      for (let n of t.childrenProperties) {
        if (n.type === B.Object) {
          ...
          e.push(
            new lt(
              r + n.beginningLineNumber - t.beginningLineNumber + s,
              n.childrenProperties,
            ),
          );
        }
        n.type === B.Array &&
          hr(e, n, r + n.beginningLineNumber - t.beginningLineNumber);
      }
    }
    var lt = class {
      constructor(t, r) {
    ...
    var ct = class {
        ...
        async getMatchingSchemas(t) {
          ...
          let n = this._languageService.parseJSONDocument(r);
          return Promise.resolve(
            this._languageService.getMatchingSchemas(r, n),
          );
        }
        _getTextDocument(t) {
