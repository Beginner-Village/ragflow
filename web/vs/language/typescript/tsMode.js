  ...
  var moduleExports = (() => {
    ...
    var ne = (n, e) => () => (
      ...
      z = (n, e, t) => (
        ...
        H(
          e || !n || !n.__esModule
            ? K(t, 'default', { value: n, enumerable: !0 })
            : t,
          n,
        )
      ),
    ...
    function U(n, e, t = 0) {
      ...
      if (((i += n.messageText), t++, n.next))
        for (let l of n.next) i += U(l, e, t);
      return i;
    }
    function S(n) {
        ...
        constructor(t, i, l, u) {
          ...
          let c = (a) => {
              ...
              let d = () => {
                  ...
                  y
                    ? a.isAttachedToEditor() && this._doValidate(a)
                    : this._doValidate(a);
                },
                p,
        ...
        _convertRelatedInformation(t, i) {
          ...
          return (
            i.forEach((u) => {
              ...
              if (
                (u.file &&
                  (c = this._libFiles.getOrCreateModel(u.file.fileName)),
                !c)
              )
                return;
              let g = u.start || 0,
      ...
      C = class n extends k {
        ...
        async resolveCompletionItem(e, t) {
          let i = e,
            ...
            ).getCompletionEntryDetails(l.toString(), c, i.label);
          return o
            ? {
                uri: l,
                position: u,
...
${Q(i)}`;
    ...
    var I = class n extends k {
        ...
        async provideSignatureHelp(t, i, l, u) {
          ...
          if (t.isDisposed()) return;
          let a = await o.getSignatureHelpItems(c.toString(), g, {
            triggerReason: n._toSignatureHelpTriggerReason(u),
          });
              ...
              ((f.documentation = { value: S(p.documentation) }),
                ...
                p.parameters.forEach((b, y, W) => {
                  ...
                  ((f.label += w),
                    f.parameters.push(Z),
                    y < W.length - 1 &&
                      (f.label += S(p.separatorDisplayParts)));
                }),
      ...
      D = class extends k {
        async provideDocumentHighlights(e, t, i) {
          let l = e.uri,
            ...
            c = await this._worker(l);
          if (e.isDisposed()) return;
          let g = await c.getDocumentHighlights(l.toString(), u, [
            l.toString(),
          ]);
          if (!(!g || e.isDisposed()))
            return g.flatMap((o) =>
        ...
        async provideDefinition(t, i, l) {
          ...
          if (
            ...
            (await this._libFiles.fetchLibFilesIfNecessary(
              o.map((d) => s.Uri.parse(d.fileName)),
            ),
            t.isDisposed())
          )
            return;
      ...
      L = class extends k {
        ...
        async provideReferences(t, i, l, u) {
          ...
          if (
            ...
            t.isDisposed() ||
            (await this._libFiles.fetchLibFilesIfNecessary(
              a.map((p) => s.Uri.parse(p.fileName)),
            ),
            t.isDisposed())
          )
            return;
          ...
          for (let p of a) {
            ...
            f &&
              d.push({
                uri: f.uri,
                range: this._textSpanToRange(f, p.textSpan),
              });
          }
          return d;
        }
...
`,
      ...
      A = class extends x {
        ...
        async provideDocumentRangeFormattingEdits(t, i, l, u) {
          ...
          if (t.isDisposed()) return;
          let d = await a.getFormattingEditsForRange(
            c.toString(),
            g,
            o,
            x._convertOptions(l),
          ...
          if (!(!d || t.isDisposed()))
            return d.map((p) => this._convertTextChanges(t, p));
        }
      },
      R = class extends x {
...
`,
        ...
        async provideOnTypeFormattingEdits(e, t, i, l, u) {
          let c = e.uri,
            ...
            o = await this._worker(c);
          if (e.isDisposed()) return;
          let a = await o.getFormattingEditsAfterKeystroke(
            c.toString(),
            g,
            i,
            x._convertOptions(l),
          ...
          if (!(!a || e.isDisposed()))
            return a.map((d) => this._convertTextChanges(e, d));
        }
      },
      O = class extends x {
        async provideCodeActions(e, t, i, l) {
          ...
          return !p || e.isDisposed()
            ...
            : {
                actions: p
                  .filter(
                    (b) => b.changes.filter((y) => y.isNewFile).length === 0,
                  )
          ...
          for (let b of p) {
            ...
            if (y)
              f.push({
                ...
                versionId: void 0,
                textEdit: {
                  range: this._textSpanToRange(y, b.textSpan),
                  text: l,
                },
              });
    ...
    function X(n, e) {
      ...
      function g() {
        ...
        (Y(i),
          o.completionItems &&
            i.push(s.languages.registerCompletionItemProvider(e, new C(u))),
          o.signatureHelp &&
            i.push(s.languages.registerSignatureHelpProvider(e, new I(u))),
          o.hovers && i.push(s.languages.registerHoverProvider(e, new P(u))),
          o.documentHighlights &&
            i.push(s.languages.registerDocumentHighlightProvider(e, new D(u))),
          o.definitions &&
            i.push(s.languages.registerDefinitionProvider(e, new F(c, u))),
          o.references &&
            i.push(s.languages.registerReferenceProvider(e, new L(c, u))),
          o.documentSymbols &&
            i.push(s.languages.registerDocumentSymbolProvider(e, new M(u))),
          o.rename &&
            i.push(s.languages.registerRenameProvider(e, new E(c, u))),
          ...
          o.onTypeFormattingEdits &&
            i.push(
              s.languages.registerOnTypeFormattingEditProvider(e, new R(u)),
            ),
          o.codeActions &&
            i.push(s.languages.registerCodeActionProvider(e, new O(u))),
          o.inlayHints &&
            i.push(s.languages.registerInlayHintsProvider(e, new N(u))),
