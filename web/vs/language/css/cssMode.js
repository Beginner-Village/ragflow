  ...
  var moduleExports = (() => {
    ...
    var Rt = (e, n) => () => (
      ...
      me = (e, n, i) => (
        ...
        z(
          n || !e || !e.__esModule
            ? X(i, 'default', { value: e, enumerable: !0 })
            : i,
          e,
        )
      ),
    ...
    (function (e) {
      ...
      function i(r) {
        let t = r;
        return (
          a.objectLiteral(t) && a.uinteger(t.line) && a.uinteger(t.character)
        );
      }
      e.is = i;
    })(I || (I = {}));
      ...
      function i(r) {
        ...
        return (
          ...
          (a.undefined(t.additionalTextEdits) ||
            a.typedArray(t.additionalTextEdits, w.is))
        );
      }
      e.is = i;
    })(_e || (_e = {}));
      ...
      function i(r) {
        ...
        return (
          ...
          (a.undefined(o.relatedInformation) ||
            a.typedArray(o.relatedInformation, te.is))
        );
      }
      e.is = i;
    })(q || (q = {}));
        ...
        return (
          ...
          (r.documentChanges === void 0 ||
            r.documentChanges.every((t) =>
              a.string(t.kind) ? ie.is(t) || oe.is(t) || se.is(t) : re.is(t),
            ))
        );
      }
      e.is = n;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          a.defined(t) &&
          h.is(t.range) &&
          (a.undefined(t.command) || b.is(t.command))
        );
      }
      e.is = i;
    })(qe || (qe = {}));
    ...
    (function (e) {
      ...
      function r(o, s) {
        let u = o.getText(),
          g = t(s, (l, p) => {
            ...
            return v === 0
              ? l.range.start.character - p.range.start.character
              : v;
          }),
          f = u.length;
        for (let l = g.length - 1; l >= 0; l--) {
          ...
          if (c <= f)
            u = u.substring(0, v) + p.newText + u.substring(c, u.length);
      ...
      function t(o, s) {
        ...
        let l = 0,
          p = 0,
          v = 0;
        for (; l < g.length && p < f.length; )
          s(g[l], f[p]) <= 0 ? (o[v++] = g[l++]) : (o[v++] = f[p++]);
...
` &&
    ...
    (function (e) {
      ...
      function g(c) {
        return (
          n.call(c) === '[object Number]' && -2147483648 <= c && c <= 2147483647
        );
      }
      e.integer = g;
      function f(c) {
    ...
    var W = class {
        ...
        let t = (s) => {
            ...
            ((this._listener[s.uri.toString()] = s.onDidChangeContent(() => {
              (window.clearTimeout(g),
                (g = window.setTimeout(() => this._doValidate(s.uri, u), 500)));
            })),
      ...
      dispose() {
        (this._disposables.forEach((n) => n && n.dispose()),
              ...
              f = s.items.map((l) => {
                ...
                return (
                  l.textEdit &&
                    (Mt(l.textEdit)
                      ? (p.range = {
                          insert: y(l.textEdit.insert),
                          replace: y(l.textEdit.replace),
                        })
                      : (p.range = y(l.textEdit.range)),
                    (p.insertText = l.textEdit.newText)),
                  l.additionalTextEdits &&
                    (p.additionalTextEdits = l.additionalTextEdits.map(P)),
    ...
    var F = class {
      ...
      provideDocumentHighlights(n, i, r) {
        ...
        return this._worker(t)
          ...
          .then((o) => {
            if (o)
              return o.map((s) => ({ range: y(s.range), kind: Nt(s.kind) }));
          });
      }
    };
    function Nt(e) {
      ...
      for (let i in e.changes) {
        ...
        for (let t of e.changes[i])
          n.push({
            resource: r,
            versionId: void 0,
            textEdit: { range: y(t.range), text: t.newText },
          });
      }
      return { edits: n };
    }
        ...
        provideLinks(n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t)
                return {
                  links: t.map((o) => ({ range: y(o.range), url: o.target })),
                };
            });
        }
      },
    ...
    var N = class {
        ...
        provideDocumentColors(n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t)
                return t.map((o) => ({ color: o.color, range: y(o.range) }));
            });
        }
        provideColorPresentations(n, i, r) {
          ...
          return this._worker(t)
            .then((o) =>
              o.getColorPresentations(t.toString(), i.color, pe(i.range)),
            )
            .then((o) => {
              if (o)
                return o.map((s) => {
                  ...
                  return (
                    ...
                    s.additionalTextEdits &&
                      (u.additionalTextEdits = s.additionalTextEdits.map(P)),
                    u
                  );
                });
            });
      ...
      function o() {
        ...
        (It(i),
          ...
          u.documentHighlights &&
            i.push(d.languages.registerDocumentHighlightProvider(s, new F(t))),
          u.definitions &&
            i.push(d.languages.registerDefinitionProvider(s, new A(t))),
          u.references &&
            i.push(d.languages.registerReferenceProvider(s, new M(t))),
          u.documentSymbols &&
            i.push(d.languages.registerDocumentSymbolProvider(s, new j(t))),
          u.rename && i.push(d.languages.registerRenameProvider(s, new K(t))),
          u.colors && i.push(d.languages.registerColorProvider(s, new N(t))),
          u.foldingRanges &&
            i.push(d.languages.registerFoldingRangeProvider(s, new O(t))),
          u.diagnostics && i.push(new W(s, t, e.onDidChange)),
          u.selectionRanges &&
            i.push(d.languages.registerSelectionRangeProvider(s, new V(t))),
          u.documentFormattingEdits &&
            i.push(
              d.languages.registerDocumentFormattingEditProvider(s, new U(t)),
            ),
