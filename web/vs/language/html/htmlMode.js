        ...
        if ((n && typeof n == 'object') || typeof n == 'function')
          for (let t of Ct(n))
            !Et.call(e, t) &&
              ...
              O(e, t, {
                get: () => n[t],
                enumerable: !(r = bt(n, t)) || r.enumerable,
              });
        return e;
      },
      ...
      function i(r) {
        ...
        return (
          ...
          (a.undefined(o.relatedInformation) ||
            a.typedArray(o.relatedInformation, Z.is))
        );
      }
      e.is = i;
    })(X || (X = {}));
        ...
        return (
          ...
          (r.documentChanges === void 0 ||
            r.documentChanges.every((t) =>
              a.string(t.kind) ? ne.is(t) || re.is(t) || ie.is(t) : te.is(t),
            ))
        );
      }
      e.is = n;
    ...
    (function (e) {
      ...
      function i(r) {
        ...
        return (
          a.defined(t) &&
          m.is(t.range) &&
          (a.undefined(t.command) || C.is(t.command))
        );
      }
      e.is = i;
    })(Qe || (Qe = {}));
    ...
    (function (e) {
      ...
      function r(o, s) {
        ...
        for (let l = g.length - 1; l >= 0; l--) {
          ...
          if (c <= f)
            u = u.substring(0, y) + p.newText + u.substring(c, u.length);
              ...
              f = s.items.map((l) => {
                ...
                return (
                  l.textEdit &&
                    (Ht(l.textEdit)
                      ? (p.range = {
                          insert: v(l.textEdit.insert),
                          replace: v(l.textEdit.replace),
                        })
                      : (p.range = v(l.textEdit.range)),
                    (p.insertText = l.textEdit.newText)),
                  l.additionalTextEdits &&
                    (p.additionalTextEdits = l.additionalTextEdits.map(R)),
...
` +
    ...
    var W = class {
      ...
      provideDocumentHighlights(n, i, r) {
        ...
        return this._worker(t)
          ...
          .then((o) => {
            if (o)
              return o.map((s) => ({ range: v(s.range), kind: Ot(s.kind) }));
          });
      }
    };
    function Ot(e) {
      ...
      for (let i in e.changes) {
        ...
        for (let t of e.changes[i])
          n.push({
            resource: r,
            versionId: void 0,
            textEdit: { range: v(t.range), text: t.newText },
          });
      }
      return { edits: n };
    }
        ...
        provideLinks(n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t)
                return {
                  links: t.map((o) => ({ range: v(o.range), url: o.target })),
                };
            });
        }
      },
    ...
    var pe = class {
        ...
        provideDocumentColors(n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t)
                return t.map((o) => ({ color: o.color, range: v(o.range) }));
            });
        }
        provideColorPresentations(n, i, r) {
          ...
          return this._worker(t)
            .then((o) =>
              o.getColorPresentations(t.toString(), i.color, me(i.range)),
            )
            .then((o) => {
              if (o)
                return o.map((s) => {
                  ...
                  return (
                    ...
                    s.additionalTextEdits &&
                      (u.additionalTextEdits = s.additionalTextEdits.map(R)),
                    u
                  );
                });
            });
    ...
    function qt(e) {
      ...
      function o() {
        ...
        (It(i),
          u.completionItems &&
            i.push(d.languages.registerCompletionItemProvider(s, new Q(t))),
          u.hovers && i.push(d.languages.registerHoverProvider(s, new P(t))),
          u.documentHighlights &&
            i.push(d.languages.registerDocumentHighlightProvider(s, new W(t))),
          u.links && i.push(d.languages.registerLinkProvider(s, new M(t))),
          u.documentSymbols &&
            i.push(d.languages.registerDocumentSymbolProvider(s, new F(t))),
          u.rename && i.push(d.languages.registerRenameProvider(s, new D(t))),
          u.foldingRanges &&
            i.push(d.languages.registerFoldingRangeProvider(s, new H(t))),
          u.selectionRanges &&
            i.push(d.languages.registerSelectionRangeProvider(s, new K(t))),
          u.documentFormattingEdits &&
            i.push(
              d.languages.registerDocumentFormattingEditProvider(s, new A(t)),
            ),
