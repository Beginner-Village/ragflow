  ...
  var moduleExports = (() => {
        ...
        if ((n && typeof n == 'object') || typeof n == 'function')
          for (let e of zn(n))
            !Hn.call(t, e) &&
              ...
              Fe(t, e, {
                get: () => n[e],
                enumerable: !(a = Rn(n, e)) || a.enumerable,
              });
        return t;
      };
    ...
    (function (t) {
      ...
      function o(a) {
        let e = a;
        return (
          w.objectLiteral(e) && w.uinteger(e.line) && w.uinteger(e.character)
        );
      }
      t.is = o;
    })(q || (q = {}));
    ...
    (function (t) {
      function n(a, e, r, u) {
        ...
        throw new Error(
          `Range#create called with invalid arguments[${a}, ${e}, ${r}, ${u}]`,
        );
      }
      t.create = n;
      function o(a) {
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          w.objectLiteral(e) &&
          W.is(e.range) &&
          (w.string(e.uri) || w.undefined(e.uri))
        );
      }
      t.is = o;
    })(me || (me = {}));
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          ...
          (w.undefined(e.additionalTextEdits) ||
            w.typedArray(e.additionalTextEdits, G.is))
        );
      }
      t.is = o;
    })(Ve || (Ve = {}));
      ...
      function o(a) {
        ...
        return (
          ...
          (w.undefined(r.codeDescription) ||
            w.string(
              (e = r.codeDescription) === null || e === void 0
                ? void 0
                : e.href,
            )) &&
          (w.string(r.source) || w.undefined(r.source)) &&
          (w.undefined(r.relatedInformation) ||
            w.typedArray(r.relatedInformation, Je.is))
        );
      }
      t.is = o;
    })(fe || (fe = {}));
    ...
    (function (t) {
      function n(a, e, r) {
        let u = { label: a };
        return (
          e !== void 0 && (u.needsConfirmation = e),
          r !== void 0 && (u.description = r),
          u
        );
      }
      t.create = n;
        ...
        return (
          ...
          (e.options === void 0 ||
            ((e.options.overwrite === void 0 ||
              w.boolean(e.options.overwrite)) &&
              (e.options.ignoreIfExists === void 0 ||
                w.boolean(e.options.ignoreIfExists)))) &&
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          w.defined(e) &&
          w.string(e.uri) &&
          (e.version === null || w.integer(e.version))
        );
      }
      t.is = o;
    })(et || (et = {}));
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          w.string(e) ||
          (w.objectLiteral(e) && w.string(e.language) && w.string(e.value))
        );
      }
      t.is = o;
    })(ge || (ge = {}));
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          w.defined(e) &&
          W.is(e.range) &&
          (w.undefined(e.command) || ne.is(e.command))
        );
      }
      t.is = o;
    })(Nt || (Nt = {}));
    ...
    (function (t) {
      ...
      function o(a) {
        let e = a;
        return (
          w.defined(e) && w.uinteger(e.tabSize) && w.boolean(e.insertSpaces)
        );
      }
      t.is = o;
    })(lt || (lt = {}));
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          w.defined(e) &&
          W.is(e.range) &&
          (w.undefined(e.target) || w.string(e.target))
        );
      }
      t.is = o;
    })(ut || (ut = {}));
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          e != null &&
          W.is(e.range) &&
          (w.string(e.expression) || e.expression === void 0)
        );
      }
      t.is = o;
    })(Vt || (Vt = {}));
      ...
      function a(r, u) {
        let c = r.getText(),
          i = e(u, (l, h) => {
            ...
            return p === 0
              ? l.range.start.character - h.range.start.character
              : p;
          }),
          s = c.length;
        for (let l = i.length - 1; l >= 0; l--) {
          ...
          if (m <= s)
            c = c.substring(0, p) + h.newText + c.substring(m, c.length);
...
` &&
    ...
    (function (t) {
      ...
      function i(m) {
        return (
          n.call(m) === '[object Number]' && -2147483648 <= m && m <= 2147483647
        );
      }
      t.integer = i;
      function s(m) {
    ...
    var De = class t {
          ...
          for (let a of n)
            if (t.isIncremental(a)) {
              ...
              let c = Math.max(e.start.line, 0),
                ...
                l = rn(a.text, !1, r);
              if (i - c === l.length)
                for (let p = 0, m = l.length; p < m; p++) s[p + c + 1] = l[p];
              else
                l.length < 1e4
                  ? s.splice(c + 1, i - c, ...l)
                  : (this._lineOffsets = s =
                      s.slice(0, c + 1).concat(l, s.slice(i + 1)));
              let h = a.text.length - (u - r);
              if (h !== 0)
                for (let p = c + 1 + l.length, m = s.length; p < m; p++)
                  s[p] = s[p] + h;
            } else if (t.isFull(a))
        ...
        getLineOffsets() {
          return (
            this._lineOffsets === void 0 &&
              (this._lineOffsets = rn(this._content, !0)),
            this._lineOffsets
          );
        }
        positionAt(n) {
    ...
    function rn(t, n, o = 0) {
      ...
      for (let e = 0; e < t.length; e++) {
        ...
        (r === 13 || r === 10) &&
          (r === 13 && e + 1 < t.length && t.charCodeAt(e + 1) === 10 && e++,
          a.push(o + e + 1));
      }
      return a;
    }
    ...
    (function (t) {
      t.LATEST = {
        textDocument: {
          completion: {
            completionItem: { documentationFormat: [Q.Markdown, Q.PlainText] },
          },
    ...
    var ft = class {
        ...
        advanceIfChar(n) {
          return n === this.source.charCodeAt(this.position)
            ? (this.position++, !0)
            : !1;
        }
        advanceIfChars(n) {
        ...
        advanceIfRegExp(n) {
          ...
          return a
            ? ((this.position = this.position + a.index + a[0].length), a[0])
            : '';
        }
        advanceUntilRegExp(n) {
          let a = this.source.substr(this.position).match(n);
          return a
            ? ((this.position = this.position + a.index), a[0])
            : (this.goToEnd(), '');
        }
        advanceUntilChar(n) {
        ...
        advanceUntilChars(n) {
          for (; this.position + n.length <= this.source.length; ) {
            ...
            for (
              ;
              o < n.length &&
              this.source.charCodeAt(this.position + o) === n[o];
              o++
            );
        ...
        advanceWhileChar(n) {
          ...
          for (
            ...
            n(this.source.charCodeAt(this.position));
            ...
            return m().length > 0
              ...
              : e.skipWhitespace()
                ? b(
                    y,
                    S.Whitespace,
                    J('Tag name must directly follow the open bracket.'),
                  )
                : ((r = H.WithinEndTag),
                  e.advanceUntilChar(ee),
                  y < e.pos()
                    ? b(y, S.Unknown, J('End tag name expected.'))
                    : T());
          case H.WithinEndTag:
            if (e.skipWhitespace()) return b(y, S.Whitespace);
            if (e.advanceIfChar(ee))
              return ((r = H.WithinContent), b(y, S.EndTagClose));
            if (a && e.peekChar() === Ce)
              return (
                (r = H.WithinContent),
                b(y, S.EndTagClose, J('Closing bracket missing.'))
              );
              ...
              l.length > 0
                ...
                : e.skipWhitespace()
                  ...
                  : ((r = H.WithinTag),
                    e.advanceUntilChar(ee),
                    y < e.pos()
                      ? b(y, S.Unknown, J('Start tag name expected.'))
                      : T())
            );
          case H.WithinTag:
                ...
                : e.advanceIfChars([mt, ee])
                  ...
                  : e.advanceIfChar(ee)
                    ...
                    : a && e.peekChar() === Ce
                      ...
                      : (e.advance(1),
                        b(y, S.Unknown, J('Unexpected character in tag.')));
          ...
          case H.BeforeAttributeValue:
            ...
            return F === qn || F === Pn
              ? (e.advance(1),
                ...
                h === 'type' &&
                  (p = e.getSource().substring(y + 1, e.pos() - 1)),
                (r = H.WithinTag),
                (s = !1),
    ...
    var Le = class {
        ...
        isSameTag(n) {
          return this.tag === void 0
            ? n === void 0
            : n !== void 0 &&
                this.tag.length === n.length &&
                this.tag.toLowerCase() === n;
        }
        get firstChild() {
      ...
      Me = class {
        ...
        parseDocument(n) {
          return this.parse(
            n.getText(),
            this.dataManager.getVoidElements(n.languageId),
          );
        }
        parse(n, o) {
          ...
          for (; r.parent; )
            ((r.end = n.length), (r.closed = !1), (r = r.parent));
          return {
            roots: e.children,
...
`))),
    ...
    var Re = class {
        constructor(n, o) {
          ((this.dataManager = n),
            (this.readDirectory = o),
            (this.atributeCompletions = []));
        }
        onHtmlAttributeValue(n) {
          this.dataManager.isPathAttribute(n.tag, n.attribute) &&
            this.atributeCompletions.push(n);
        }
        ...
        async providePathSuggestions(n, o, a, e) {
          ...
          if (u)
            try {
              ...
              for (let [s, l] of i)
                s.charCodeAt(0) !== ri && c.push(li(s, l === Ee.Directory, o));
              return c;
            } catch {}
          return [];
        }
    ...
    var ze = class {
      ...
      async doComplete2(n, o, a, e, r) {
        ...
        try {
          ...
          return {
            isIncomplete: i.isIncomplete || s.isIncomplete,
            items: s.items.concat(i.items),
          };
        } finally {
      ...
      _doComplete(n, o, a, e) {
        let r = { isIncomplete: !1, items: [] },
          ...
          c = this.dataManager
            ...
            .filter(
              (k) =>
                k.isApplicable(n.languageId) && (!e || e[k.getId()] !== !1),
            ),
        ...
        function D(k, x = h) {
          return (
            k > h && (k = h),
            { start: n.positionAt(k), end: n.positionAt(x) }
          );
        }
        function T(k, x) {
          let M = D(k, x);
...
\r`.indexOf(M) >= 0
          ...
          for (x && (z = z.parent); z; ) {
            ...
            if (U && (!z.closed || (z.endTagStart && z.endTagStart > h))) {
              ...
              if (j !== null && K !== null && j !== K) {
                let ae = j + '</' + U + O;
                ((P.textEdit = G.replace(D(k - 1 - K.length), ae)),
                  (P.filterText = K + '</' + U));
              }
        ...
        function R(k) {
          return h === m.getTokenEnd() &&
            ((E = m.scan()), E === k && m.getTokenOffset() === h)
            ? m.getTokenEnd()
            : h;
        }
        function v() {
          for (let k of u)
            k.onHtmlContent && k.onHtmlContent({ document: n, position: o });
          return _();
        }
        function _() {
          let k = h - 1,
        ...
        if (r === '>') {
          ...
          if (
            ...
            for (; s !== S.EOS && i.getTokenEnd() <= e; ) {
              if (s === S.StartTagClose && i.getTokenEnd() === e)
                return `$0</${c.tag}>`;
              s = i.scan();
            }
          }
          ...
          for (; u && u.closed && !(u.endTagStart && u.endTagStart > e); )
            u = u.parent;
          if (u && u.tag) {
      ...
      doesSupportMarkdown() {
        if (!de(this.supportsMarkdown)) {
          ...
          this.supportsMarkdown =
            Array.isArray(n) && n.indexOf(Q.Markdown) !== -1;
        }
    ...
    var Ie = class {
      ...
      doHover(n, o, a, e) {
        ...
        let l = this.dataManager
          .getDataProviders()
          .filter((f) => f.isApplicable(n.languageId));
        function h(f, d, g) {
          for (let R of l) {
            let v = null;
            if (
        ...
        function b(f, d) {
          ...
          for (
            ;
            R !== S.EOS &&
            (g.getTokenEnd() < c || (g.getTokenEnd() === c && R !== f));

          )
            R = g.scan();
          return R === f && c <= g.getTokenEnd()
            ? {
                start: n.positionAt(g.getTokenOffset()),
                end: n.positionAt(g.getTokenEnd()),
              }
            : null;
        }
        function D() {
      ...
      convertContents(n) {
        if (!this.doesSupportMarkdown()) {
          ...
          if (Array.isArray(n))
            n.map((o) => (typeof o == 'string' ? o : o.value));
          else return n.value;
        }
        return n;
      }
      ...
      var t = [
          ...
          function (e) {
            ...
            ((r.prototype.clone_empty = function () {
              ...
              return (
                i.set_indent(this.__indent_count, this.__alignment_count),
                i
              );
            }),
              (r.prototype.item = function (i) {
                return i < 0
                  ? this.__items[this.__items.length + i]
                  : this.__items[i];
              }),
                ...
                if (this._should_wrap()) {
                  ...
                  return (
                    ...
                    (this.__character_count =
                      this.__wrap_point_character_count),
                    i.__items[0] === ' ' &&
                      (i.__items.splice(0, 1), (i.__character_count -= 1)),
                    !0
                  );
                }
                return !1;
...
`);
            ...
            function u(i, s) {
              ((this.__cache = ['']),
                ...
                i.indent_with_tabs ||
                  (this.__indent_string = new Array(i.indent_size + 1).join(
                    i.indent_char,
                  )),
                (s = s || ''),
                i.indent_level > 0 &&
                  (s = new Array(i.indent_level + 1).join(
...
You passed in: '` +
            ...
            ((e.exports.Options = r),
              (e.exports.normalizeOpts = c),
              (e.exports.mergeOpts = u));
          },
          ,
          function (e) {
            ...
            ((u.prototype.restart = function () {
              ...
              (u.prototype.lookBack = function (c) {
                ...
                return (
                  i >= c.length &&
                  this.__input.substring(i - c.length, i).toLowerCase() === c
                );
              }),
...
`
              ...
              (y.prototype.eatWhitespace = function (L) {
                for (
                  var I = A.test(this._input.peek()), N = 0;
...
`,
                ...
                for (
                  ...
                  if (this._ch === '/' && this._input.peek() === '*') {
                    ...
                    if (
                      (this.preserveSingleSpace(k), this._input.peek() === '{')
                    )
                    ...
                    for (
                      var U = 0;
                      U < this.NON_SEMICOLON_NEWLINE_PROPERTY.length;
                      U++
                    )
                      if (
                        this._input.lookBack(
                          this.NON_SEMICOLON_NEWLINE_PROPERTY[U],
                        )
                      ) {
                        C = !0;
                        break;
          ...
          function (e, r, u) {
            ...
            function i(s) {
              ...
              this.space_around_combinator =
                this._get_boolean('space_around_combinator') || l;
          ...
          function (e) {
            ...
            ((r.prototype.restart = function () {
              ...
              (r.prototype.next = function () {
                ...
                return (
                  this.hasNext() &&
                    ((u = this.__tokens[this.__position]),
                    (this.__position += 1)),
                  u
                );
              }),
            ...
            ((i.prototype = new c()),
              ...
              (i.prototype.__split = function (s, l) {
                ...
                for (var h = 0, p = [], m = s.exec(l); m; )
                  (p.push(l.substring(h, m.index)),
                    (h = m.index + m[0].length),
                    (m = s.exec(l)));
                return (
                  h < l.length ? p.push(l.substring(h, l.length)) : p.push(''),
                  p
                );
              }),
          ...
          function (e) {
            ...
            ((r.prototype.read = function () {
              ...
              (r.prototype.starting_with = function (u) {
                var c = this._create();
                return (
                  (c._starting_pattern = this._input.get_regexp(u, !0)),
                  c._update(),
                  c
                );
              }),
              (r.prototype.matching = function (u) {
                var c = this._create();
                return (
                  (c._match_pattern = this._input.get_regexp(u, !0)),
                  c._update(),
                  c
                );
              }),
          ...
          function (e, r, u) {
            ...
            ((s.prototype = new c()),
              ...
              (s.prototype.read_options = function (l) {
                var h = this._create();
                for (var p in i)
                  h._disabled[p] = l.templating.indexOf(p) === -1;
                return (h._update(), h);
              }),
              ...
              (s.prototype.read = function () {
                ...
                return (
                  this._until_after &&
                    (l += this._input.readUntilAfter(this._until_pattern)),
                  l
                );
              }),
              (s.prototype.__set_templated_pattern = function () {
                var l = [];
                (this._disabled.php ||
                  l.push(this.__patterns.php._starting_pattern.source),
                  this._disabled.handlebars ||
                    l.push(this.__patterns.handlebars._starting_pattern.source),
                  this._disabled.erb ||
                    l.push(this.__patterns.erb._starting_pattern.source),
                  ...
                  this._disabled.smarty ||
                    l.push(this.__patterns.smarty._starting_pattern.source),
            ...
            ((m.prototype.current_line_has_match = function (f) {
              ...
              (m.prototype.set_space_before_token = function (f, d) {
                ((this._output.space_before_token = f),
                  (this._output.non_breaking_space = d));
              }),
              ...
              (L.prototype._handle_control_flow_open = function (f, d) {
                ...
                return (
                  f.set_space_before_token(
                    d.newlines || d.whitespace_before !== '',
                    !0,
                  ),
                  d.newlines
...
` +
              ...
              (L.prototype._handle_tag_open = function (f, d, g, R, v) {
                ...
                if (
                  ...
                  do
                    ((E = v.peek(C)),
                      E.type === l.ATTRIBUTE && (_.attr_count += 1),
                      (C += 1));
                ...
                return (
                  ...
                  !_.tag_complete &&
                    !_.is_unformatted &&
                    (f.alignment_size = _.alignment_size),
                  _
                );
              }));
            var I = function (f, d) {
            ...
            ((L.prototype._get_tag_open_token = function (f) {
              ...
              return (
                ...
                (d.is_end_tag =
                  d.is_end_tag || D(d.tag_check, this._options.void_elements)),
                (d.is_empty_element =
                  d.tag_complete || (d.is_start_tag && d.is_end_tag)),
                (d.is_unformatted =
                  !d.tag_complete && D(d.tag_check, this._options.unformatted)),
                (d.is_content_unformatted =
                  !d.is_empty_element &&
                  D(d.tag_check, this._options.content_unformatted)),
                (d.is_inline_element =
              ...
              (L.prototype._set_tag_position = function (f, d, g, R, v) {
                if (
                  (g.is_empty_element ||
                    (g.is_end_tag
                      ? (g.start_tag_token = this._tag_stack.try_pop(
                          g.tag_name,
                        ))
...
`) === -1) ||
                  ...
                  var C = !1;
                  ((C =
                    g.start_tag_token && g.start_tag_token.multiline_content),
                    (C =
                      C ||
                      (!g.is_inline_element &&
              ...
              (L.prototype._calcluate_parent_multiline = function (f, d) {
                d.parent &&
                  ...
                  !(
                    (d.is_inline_element || d.is_unformatted) &&
                    d.parent.is_inline_element
                  ) &&
            ...
            ((L.prototype._do_optional_end_element = function (f) {
              ...
              if (!(f.is_empty_element || !f.is_start_tag || !f.parent)) {
                if (f.tag_name === 'body')
                  d = d || this._tag_stack.try_pop('head');
                  ...
                  f.parent.tag_name === 'p' &&
                  N.indexOf(f.tag_name) !== -1
                ) {
                  var g = f.parent.parent;
                  (!g || F.indexOf(g.tag_name) === -1) &&
                    (d = d || this._tag_stack.try_pop('p'));
                } else
                  f.tag_name === 'rp' || f.tag_name === 'rt'
                    ? ((d =
                        d || this._tag_stack.try_pop('rt', ['ruby', 'rtc'])),
                      (d = d || this._tag_stack.try_pop('rp', ['ruby', 'rtc'])))
                    : f.tag_name === 'optgroup'
                      ? (d =
                          d || this._tag_stack.try_pop('optgroup', ['select']))
                      : f.tag_name === 'option'
                        ? (d =
                            d ||
          ...
          function (e, r, u) {
            var c = u(9).Tokenizer,
              ...
              A = function (b, D) {
                ...
                if (
                  ...
                  this.__patterns.unformatted_content_delimiter = y
                    .matching(L)
                    .until_after(L);
                }
              };
            ((A.prototype = new c()),
              ...
              (A.prototype._get_next_token = function (b, D) {
                ...
                return y === null
                  ...
                  : ((T = T || this._read_open_handlebars(y, D)),
                    ...
                    (T =
                      T || this._create_token(p.UNKNOWN, this._input.next())),
                    T);
              }),
                  ...
                  (L === '!' &&
                    ...
                    T
                      ? ((y = m.get_directives(T)),
                        y &&
                          y.ignore === 'start' &&
                          (T += m.readIgnored(this._input)))
                      : (T = this.__patterns.cdata.read())),
                    T &&
                      ((D = this._create_token(p.COMMENT, T)),
                      (D.directives = y)));
                }
                return D;
              }),
              ...
              (A.prototype._read_control_flows = function (b, D) {
                ...
                if (b === '@') {
                  if (
                    ((T = this.__patterns.angular_control_flow_start.read()),
                    T === '')
                  )
                    return y;
                  for (
                    var L = T.endsWith('(') ? 1 : 0, I = 0;
                    !(T.endsWith('{') && L === I);
                  ...
                  b === '}' &&
                    ...
                    ((T = this._input.next()),
                    (y = this._create_token(p.CONTROL_FLOW_CLOSE, T)));
                return y;
              }),
              ...
              (A.prototype._read_attribute = function (b, D, T) {
                ...
                if (T && T.text[0] === '<')
                  if (b === '=')
                    y = this._create_token(p.EQUALS, this._input.next());
                  else if (b === '"' || b === "'") {
    ...
    function _n(t, n, o) {
      ...
      if (n) {
        ...
        ((p === a.length || bn(a, p)) && (h = p),
          (n = W.create(t.positionAt(s), t.positionAt(h))));
...
`,
          ...
          templating: fi(o, 'all'),
          unformatted_content_delimiter: Y(
            o,
...
`.indexOf(t.charAt(n)) !== -1
    ...
    (() => {
      ...
      var t = {
          470: (e) => {
            ...
            var c = {
              resolve: function () {
                for (
                  var i, s = '', l = !1, h = arguments.length - 1;
                  h >= -1 && !l;
                  h--
                ) {
                  var p;
                  (h >= 0
                    ? (p = arguments[h])
                    : (i === void 0 && (i = process.cwd()), (p = i)),
                    r(p),
                    p.length !== 0 &&
                      ((s = p + '/' + s), (l = p.charCodeAt(0) === 47)));
                }
                return (
                  (s = u(s, !l)),
              ...
              relative: function (i, s) {
                if (
                  (r(i),
                  r(s),
                  i === s || (i = c.resolve(i)) === (s = c.resolve(s)))
                )
                  return '';
                ...
                for (
                  var A = s.length - m, b = p < A ? p : A, D = -1, T = 0;
                  T <= b;
                  ++T
                ) {
                  if (T === b) {
              ...
              extname: function (i) {
                r(i);
                for (
                  var s = -1, l = 0, h = -1, p = !0, m = 0, A = i.length - 1;
                  A >= 0;
                  --A
                ) {
              ...
              parse: function (i) {
                ...
                p ? ((s.root = '/'), (l = 1)) : (l = 0);
                for (
                  var m = -1, A = 0, b = -1, D = !0, T = i.length - 1, y = 0;
                  T >= l;
                  --T
                )
      ...
      ((o.d = (e, r) => {
        for (var u in r)
          o.o(r, u) &&
            !o.o(e, u) &&
            Object.defineProperty(e, u, { enumerable: !0, get: r[u] });
      }),
        ...
        function D(v, _, C) {
          ...
          for (let x = 0; x < v.length; x++) {
            ...
            if (
              ...
              (k !== -1 &&
                ((E += encodeURIComponent(v.substring(k, x))), (k = -1)),
          ...
          return (
            k !== -1 && (E += encodeURIComponent(v.substring(k))),
            E !== void 0 ? E : v
          );
        }
        function T(v) {
            ...
            (C =
              v.authority && v.path.length > 1 && v.scheme === 'file'
                ...
                : v.path.charCodeAt(0) === 47 &&
                    ((v.path.charCodeAt(1) >= 65 &&
                      v.path.charCodeAt(1) <= 90) ||
                      (v.path.charCodeAt(1) >= 97 &&
                        v.path.charCodeAt(1) <= 122)) &&
        ...
        function L(v, _) {
          ...
          if (M) {
            if (
              ...
              z >= 65 &&
                z <= 90 &&
                (M = `/${String.fromCharCode(z + 32)}:${M.substr(3)}`);
            } else if (M.length >= 2 && M.charCodeAt(1) === 58) {
              let z = M.charCodeAt(0);
              z >= 65 &&
                z <= 90 &&
                (M = `${String.fromCharCode(z + 32)}:${M.substr(2)}`);
            }
            E += C(M, !0, !1);
          }
          return (
        ...
        (function (v) {
          ((v.joinPath = function (_, ...C) {
            ...
            (v.resolvePath = function (_, ...C) {
              ...
              let x = d.resolve(E, ...C);
              return (
                k && x[0] === g && !_.authority && (x = x.substring(1)),
                _.with({ path: x })
              );
            }),
            (v.dirname = function (_) {
              ...
              return (
                C.length === 1 && C.charCodeAt(0) === 46 && (C = ''),
                _.with({ path: C })
              );
            }),
    ...
    function yi(t, n) {
      try {
        ...
        return (
          o.scheme === 'file' &&
            o.query &&
            ((o = o.with({ query: null })), (t = o.toString(!0))),
          o.scheme === 'file' &&
          o.fragment &&
          ...
          switch (r) {
            ...
            case S.AttributeValue:
              if (c && u && this.dataManager.isPathAttribute(c, u)) {
                ...
                (i &&
                  typeof s > 'u' &&
                  ((s = _t(h)), s && o && (s = o.resolveReference(s, n.uri))),
                  (i = !1),
                  (u = void 0));
              } else if (u === 'id') {
    ...
    function An(t, n, o) {
      ...
      return (
        ((u && kn(u, n)) || (c && kn(c, n))) &&
          (u && r.push({ kind: ue.Read, range: u }),
          c && r.push({ kind: ue.Read, range: c })),
        r
      );
    }
    function Tn(t, n) {
      return (
        t.line < n.line || (t.line === n.line && t.character <= n.character)
      );
    }
    function kn(t, n) {
    ...
    function Sn(t, n, o) {
      ...
      return e !== S.EOS
        ? {
            start: n.positionAt(a.getTokenOffset()),
            end: n.positionAt(a.getTokenEnd()),
          }
        : null;
    }
    function xn(t, n) {
    ...
    function En(t, n, o, a) {
      ...
      let u = [],
        c = {
          start: t.positionAt(r.start + 1),
          end: t.positionAt(r.start + 1 + r.tag.length),
        };
      ...
      return e.endTagStart &&
        ...
        ? [
            ...
            W.create(
              ...
              t.positionAt(e.endTagStart + 2 + r),
            ),
          ]
        : null;
    }
                ...
                if (A[1]) c.push({ startLine: p, tagName: '' });
                  ...
                  if (b >= 0) {
                    ...
                    ((p = D.startLine),
                      T > p &&
                        s !== p &&
                        l({ startLine: p, endLine: T, kind: oe.Region }));
                  }
                }
              else {
                let b = n.positionAt(
                  e.getTokenOffset() + e.getTokenLength(),
                ).line;
    ...
    var Oe = class {
      ...
      getSelectionRange(n, o, a) {
        ...
        for (let c = e.length - 1; c >= 0; c--) {
          ...
          ((!r || i[0] !== r[0] || i[1] !== r[1]) &&
            (u = ce.create(
              W.create(o.positionAt(e[c][0]), o.positionAt(e[c][1])),
              u,
            )),
            (r = i));
        }
      ...
      getApplicableRanges(n, o, a) {
        ...
        if (r.startTagEnd && !r.endTagStart) {
          ...
          let c = W.create(
            n.positionAt(r.startTagEnd - 2),
            n.positionAt(r.startTagEnd),
          );
          return (
            n.getText(c) === '/>'
          ...
          : (u.unshift([r.start, r.end]),
            r.start < e && e < r.startTagEnd
              ...
              : r.startTagEnd <= e && e <= r.endTagStart
                ...
                : (e >= r.endTagStart + 2 &&
                    u.unshift([r.endTagStart + 2, r.end - 1]),
                  u));
      }
      getAllParentTagRanges(n) {
        let o = n,
          a = [];
        for (; o.parent; )
          ((o = o.parent), this.getNodeRanges(o).forEach((e) => a.push(e)));
        return a;
      }
      getNodeRanges(n) {
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
      ...
      valueSets: [
        ...
        {
          name: 'decoding',
          values: [{ name: 'sync' }, { name: 'async' }, { name: 'auto' }],
        },
        {
          name: 'loading',
          values: [
    ...
    var Be = class {
        constructor(n) {
          ((this.dataProviders = []),
            this.setDataProviders(
              n.useDefaultDataProvider !== !1,
              n.customDataProviders || [],
            ));
        }
        ...
        isVoidElement(n, o) {
          return (
            !!n && ln(o, n.toLowerCase(), (a, e) => a.localeCompare(e)) >= 0
          );
        }
        getVoidElements(n) {
          let o = Array.isArray(n)
              ? n
              : this.getDataProviders().filter((e) => e.isApplicable(n)),
            a = [];
          return (
            o.forEach((e) => {
              e.provideTags()
    ...
    var Ne = class {
      constructor(n, o) {
        ...
        let a = this._languageSettings.data,
          ...
          r = [];
        if (a?.dataProviders)
          for (let u in a.dataProviders) r.push(Mn(u, a.dataProviders[u]));
        this._languageService = Ln({
