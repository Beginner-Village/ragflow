  ...
  return (
    ...
    >
      ...
      <Link
        href={
          isAgent
            ? 'https://ynetflow.io/docs/dev/http_api_reference#create-session-with-agent'
            : 'https://ynetflow.io/docs/dev/http_api_reference#create-session-with-chat-assistant'
        }
        target="_blank"
      >
